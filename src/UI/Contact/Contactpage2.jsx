  ...
  return (
    ...
    <div class="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 class="mt-2 text-4xl font-bold text-gray-800 md:text-3xl dark:text-white">Let’s build an awesome <br></br> project together</h1>

            <p class="mt-3 text-gray-500 dark:text-gray-400 text-2xl">At our IT solution company, we are committed to exceptional customer service and support. <br></br> If you are experiencing technical difficulties or need assistance with</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">ovie323@github</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+234 (080) 39284683 </p>
                </div>
            </div>
